...
module.exports = function (Item) {
    ...
    Object.keys(Item).forEach(function (key) {
        if (key == '__jsogObjectId') { /*ignore*/
        }
        else if (Item[key].S !== undefined)
            obj[key] = Item[key].S;
        ...
        else if (Item[key].B !== undefined)
            obj[key] = new Buffer(Item[key].B, 'base64');
        else if (Item[key].SS !== undefined)
            obj[key] = Item[key].SS;
        else if (Item[key].NS !== undefined)
        ...
        else if (Item[key].BS !== undefined)
            obj[key] = _.collect(Item[key].BS, function (b) {
